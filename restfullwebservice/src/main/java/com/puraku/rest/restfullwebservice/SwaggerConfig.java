 ...
 * Contact("Puneet R Kulkarni", "http://aatmanirbharPuneet.com",
 * "puneetrkulkarni@gmail.com");
 * 
 * public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("My API Title",
 * "Awesome API description", "1.0", "urn:termsOfServiceUrl", DEFAULT_CONTACT,
 * "Apache 2.0", "licenseUrl");
 * 
